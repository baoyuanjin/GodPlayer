...
public class StatusBarUtils {
     ...
     *
     * @param mActivity
     * @param type      true 全透明   false 半透明
     */
    public static void setStatusTransparent(Activity mActivity, boolean type) {
        if (type) {
...
//        }
     ...
     * 沉浸式体验
     */
    public static void setImmersionExperience(boolean hasFocus, Activity mActivity) {
