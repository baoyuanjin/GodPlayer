...
public abstract class Camera3Base
...
//    videoEncoder = new VideoEncoder(this);
  ...
  public Camera3Base(SurfaceView surfaceView) {
  ...
  public Camera3Base(OpenGlView openGlView) {
  ...
  public Camera3Base(LightOpenGlView lightOpenGlView) {
