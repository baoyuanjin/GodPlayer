 ...
 * Describe
 */
public class PopupWindowInputUser extends PopupWindow {
    ...
    public PopupWindowInputUser(Activity context) {
        this.mContext = context;

        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.pop_add_user, null);
