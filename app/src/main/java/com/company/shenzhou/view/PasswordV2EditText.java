 ...
 */
public final class PasswordV2EditText extends RegexEditText
    ...
    public PasswordV2EditText(Context context) {
        this(context, null);
    }

    public PasswordV2EditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    @SuppressWarnings("all")
    @SuppressLint("ClickableViewAccessibility")
    public PasswordV2EditText(Context context, AttributeSet attrs, int defStyleAttr) {
