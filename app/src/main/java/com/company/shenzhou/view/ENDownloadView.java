...
public class ENDownloadView extends View {
    ...
    private ENDownloadView.OnDownloadStateListener onDownloadStateListener;
...
//        int textSize = ta.getInteger(R.styleable.download_download_text_size, DEFAULT_TEXT_SIZE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentState) {
            ...
            case STATE_DOWNLOADING:
                ...
                canvas.restore();
                if (mUnit != ENDownloadView.DownloadUnit.NONE && mCurrentSize > 0) {
    ...
    private void downloadAnim() {
        ...
        mValueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                mFraction = valueAnimator.getAnimatedFraction();
                if (mUnit != ENDownloadView.DownloadUnit.NONE && mTotalSize > 0)
    ...
    private String getUnitStr(ENDownloadView.DownloadUnit unit) {
        switch (unit) {
            case GB:
                return " gb";
            case MB:
    ...
    public void setDownloadConfig(int downloadTime, double downloadFileSize, ENDownloadView.DownloadUnit unit) {
    ...
    public void setOnDownloadStateListener(ENDownloadView.OnDownloadStateListener onDownloadStateListener) {
