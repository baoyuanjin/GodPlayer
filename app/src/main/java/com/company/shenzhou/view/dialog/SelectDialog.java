...
import com.company.shenzhou.base.MyAdapter;
import com.company.shenzhou.view.RecycleViewDivider;
...
public final class SelectDialog {
    ...
    public static final class Builder
            extends UIDialogSelect.Builder<Builder> {
...
//            recyclerView.addItemDecoration(new RecycleViewDivider(getActivity(),1, R.drawable.recicleview_divider_line));
...
//                        Toast.show(String.format(getString(R.string.select_min_hint), mAdapter.getMinSelect()));
                    }
                    break;
