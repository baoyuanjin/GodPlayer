...
public final class SwitchButton extends View {
     ...
     * 开启状态背景色
     */   //#007AFF  ==0,122,255
    protected int mAccentColor = 0xFF007AFF;
//    protected int mAccentColor = 0xFF4BD763;
    /**
     * 开启状态按钮描边色
     */
    protected int mPrimaryDarkColor = 0xFF007AFF;
...
//                    }
    ...
    public void setOnMyClickListener(onMyClickListener mMyClickListener) {
